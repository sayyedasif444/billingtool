...
export default function CreateInvoiceForm({ businessId, onSuccess, onCancel }: CreateInvoiceFormProps) {
    ...
    >
      <Card className="shadow-2xl border-white/20">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-bold text-white">Create New Invoice</CardTitle>
