    ...
    <div className="flex flex-col h-screen overflow-hidden bg-black/40">
      ...
      <header className="flex-shrink-0 border-b border-white/5 bg-white/5 p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2 sm:gap-3 w-full sm:w-auto">
          <div className="flex items-center gap-1.5 flex-1 sm:flex-initial min-w-[200px] sm:min-w-0">
            <select
              value={activeSprintId}
              onChange={(e) => setActiveSprintId(e.target.value)}
              className="h-10 rounded-md border border-white/10 bg-black/40 px-3 py-2 text-sm text-white focus:outline-none focus:ring-2 focus:ring-primary flex-1 sm:w-[200px]"
            >
            ...
            {activeSprintId && (
              <Button
                ...
                className="h-10 w-10 p-0 text-slate-300 hover:text-white border-white/10 hover:bg-white/5 flex-shrink-0"
              >
          ...
          <Button 
            ...
            className="border-indigo-500/30 hover:border-indigo-500/50 text-indigo-400 hover:text-white px-3 sm:px-4 text-xs sm:text-sm"
          >
          ...
          <Button 
            ...
            className="border-emerald-500/30 hover:border-emerald-500/50 text-emerald-400 hover:text-white px-3 sm:px-4 text-xs sm:text-sm"
          >
